                        ...
                        var theElement = $(this),
                            widgetOptions = $.mobile.toolbar && theElement.data("mobile-toolbar")
                                ...
                                : {
                                    ...
                                    updatePagePadding: (theElement.attr("data-" +
                                            $.mobile.ns +
                                            "update-page-padding") !==
                                        false)
                                };
...
// thx Modernizr
            ...
            var fakeBody = $("<body>").prependTo("html"),
                ...
                bb =
                    window.blackberry &&
                        !propExists(
                            "-webkit-transform"), //only used to rule out box shadow, as it's filled opaque on BB 5 and lower
                nokiaLTE7_3;
...
// default enhanced qualifications are media query support OR IE 7+
            ...
            $.mobile.gradeA = function() {
                return (($.support.mediaquery && $.support.cssPseudoElement) ||
                ...
                base = {
                    ...
                    rewrite: function(href, page) {
                        ...
                        page.find(base.linkSelector).each(function(i, link) {
                            ...
                            thisUrl = thisUrl.replace(theLocation.protocol +
...
// For backcompat remove in 1.5
            ...
            $.widget("mobile.pagecontainer",
                {
                    ...
                    _handleNavigate: function(url, data) {
                        ...
                        var to = $.mobile.path.stripHash(url),
                            ...
                            transition = history.stack.length === 0
                                ? "none"
                    ...
                    _loadSuccess: function(absUrl, triggerData, settings, deferred) {
                        ...
                        return $.proxy(function(html, textStatus, xhr) {
                                ...
                                var content,
                                    ...
                                    pageElemRegex =
                                        new RegExp("(<[^>]+\\bdata-" + this._getNs() + "role=[\"']?page[\"']?[^>]*>)"),

                                    dataUrlRegex =
                                        new RegExp("\\bdata-" + this._getNs() + "url=[\"']?([^\"'>]*)[\"']?");
        ...
        (function($, undefined) {
            ...
            $.mobile._registerInternalEvents = function() {
                ...
                $.mobile.document.bind("click",
                    function(event) {
                        ...
                        useDefaultUrlHandling = $link.is("[rel='external']") ||
                        ...
                        $.mobile.changePage(href,
                            { transition: transition, reverse: reverse, role: role, link: $link });
                        event.preventDefault();
                    });

                //prefetch pages when anchors with data-prefetch are encountered
                $.mobile.document.delegate(".ui-page",
                    "pageshow.prefetch",
                    function() {
                        var urls = [];
                        $(this).find("a:jqmData(prefetch)").each(function() {
                            ...
                            if (url && $.inArray(url, urls) === -1) {
                                ...
                                $.mobile.loadPage(url,
                                    { role: $link.attr("data-" + $.mobile.ns + "rel"), prefetch: true });
                            }
                        });
                    });
            ...
            $.when(domreadyDeferred, $.mobile.navreadyDeferred)
                .done(function() { $.mobile._registerInternalEvents(); });
        })(jQuery);
        ...
        (function($) {
            ...
            $.extend($.mobile.SerialTransition.prototype,
            ...
            $.widget("mobile.collapsible",
                {
                    ...
                    _getOptions: function(options) {
                        ...
                        for (key in options) {
                            ...
                            options[key] =
                                ...
                                : accordion.length
                                ? $.mobile.getAttribute(accordion[0],
                    ...
                    _handleExpandCollapse: function(isCollapse) {
                        ...
                        ui.heading
                            ...
                            .toggleClass("ui-icon-" + opts.collapsedIcon,
...
*/
        ...
        (function($) {
            var meta = $("meta[name=viewport]"),
                ...
                disabledInitially =
                    /(user-scalable[\s]*=[\s]*no)|(maximum-scale[\s]*=[\s]*1)[$,\s]/.test(initialContent);
                ...
                $.extend({
                        ...
                        _create: function() {
                            ...
                            var self = this,
                                ...
                                slider = $(domSlider),
                                valuebg = this.options.highlight && !isToggleSwitch
                                    ? (function() {
                            ...
                            domSlider.className = [
                                ...
                                : "ui-slider-track ui-shadow-inset ", selectClass, trackThemeClass, cornerClass,
                                miniClass
                            ].join("");
                            ...
                            if (isToggleSwitch) {
                                ...
                                for (i = 0, optionsCount = options.length; i < optionsCount; i++) {
                                    ...
                                    sliderImg.className =
                                        ["ui-slider-label ui-slider-label-", side, activeClass].join("");
                            ...
                            case $.mobile.keyCode.LEFT:
                                ...
                                if (!this._keySliding) {
                                    ...
                                    this.handle.addClass(
                                        "ui-state-active"); /* TODO: We don't use this class for styling. Do we need to add it? */
                                }
                        ...
                        refresh: function(val, isfromControl, preventInputUpdate) {
                            ...
                            self.slider[0].className = [
                                ...
                                : "ui-slider-track ui-shadow-inset", trackThemeClass, cornerClass, miniClass
                            ].join("");
                            ...
                            step = (isInput && parseFloat(control.attr("step")) > 0)
                ...
                $.extend({
                        ...
                        _updateHighlight: function() {
                            var min = parseInt(
                                    ...
                                    10),
                                max = parseInt($.data(this._inputLast.get(0), "mobile-slider").handle.get(0).style.left,
                                    10),
                                width = (max - min);
                        ...
                        _destroy: function() {
                            ...
                            if (wrapper.length > 0) {
                                if (wrapper.is(".ui-btn-left, .ui-btn-right")) {
                                    this.element.addClass(wrapper.hasClass("ui-btn-left")
                                        ? "ui-btn-left"
                                        : "ui-btn-right");
                                }
            ...
            $.widget("mobile.popup",
                {
                    ...
                    open: function(options) {
                        ...
                        if (!(currentOptions.history)) {
                            ...
                            self.element
                                .delegate(currentOptions.closeLinkSelector,
            ...
            $.widget("mobile.selectmenu",
                $.mobile.selectmenu,
                {
                    _create: function() {
                        ...
                        o.nativeMenu =
                            o.nativeMenu || (this.element.parents(":jqmData(role='popup'),:mobile-popup").length > 0);
                    ...
                    build: function() {
                        ...
                        overlayThemeAttr = overlayTheme
                            ? (" data-" +
                                ...
                                "'")
                            : "";
                        dividerThemeAttr = (o.dividerTheme && isMultiple)
                        ...
                        listbox = $("<div" +
                            ...
                            .popup();
                        list = $("<ul class='ui-selectmenu-list' id='" +
                            menuId +
            ...
            $.widget("mobile.toolbar",
                $.mobile.toolbar,
                {
                    ...
                    updatePagePadding: function(tbPage) {
                        ...
                        tbPage =
                            (tbPage && tbPage.type === undefined && tbPage) || this.page || $el.closest(".ui-page");
                    ...
                    _getPanelInner: function() {
                        ...
                        if (panelInner.length === 0) {
                            panelInner =
                                ...
                                .wrapAll("<div class='" + this.options.classes.panelInner + "' />").parent();
                        }
                            ...
                            var self = this,
                                ...
                                _openPanel = function() {
                                    ...
                                    self._pageContentOpenClasses =
                                        self._getPosDisplayClasses(o.classes.pageContentPrefix);
...
// TODO rename filterCallback/deprecate and default to the item itself as the first argument
            var defaultFilterCallback = function(index, searchValue) {
                return (("" + ($.mobile.getAttribute(this, "filtertext") || $(this).text()))
                    .toLowerCase().indexOf(searchValue) ===
                    -1);
            };
        ...
        (function($, window, undefined) {
            ...
            $(function() {
                ...
                if (!$.support.cssPointerEvents) {
                    ...
                    // only ui-state-disabled should be present thereafter
                    $.mobile.document.delegate(".ui-state-disabled,.ui-disabled",
                        "vclick",
                        function(e) {
                            e.preventDefault();
